...
# Highly Aggressive (~93% precision target) | TP=+1, FP=-15, FN=-0.25, TN=0 | FP:FN ratio 60:1
WEIGHTS = {"tp": 1, "fp": -15, "fn": -0.25, "tn": 0}
...
def product_mismatch_weighted_metric(request):
    try:
        ...
        logger.info(f"highly_aggressive | Score: {score} | GT: {ground_truth}")
