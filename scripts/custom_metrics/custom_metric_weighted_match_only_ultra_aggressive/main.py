...
# Ultra Aggressive (~95% precision target) | TP=+1, FP=-25, FN=-0.25, TN=0 | FP:FN ratio 100:1
WEIGHTS = {"tp": 1, "fp": -25, "fn": -0.25, "tn": 0}
...
def product_match_weighted_metric(request):
    try:
        ...
        logger.info(f"ultra_aggressive | Score: {score} | GT: {ground_truth}")
