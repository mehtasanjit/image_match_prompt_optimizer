...
# Guarded Precision (~90% with recall floor) | TP=+1, FP=-9, FN=-2, TN=+0.5 | FP:FN ratio 4.5:1
WEIGHTS = {"tp": 1, "fp": -9, "fn": -2, "tn": 0.5}
...
def product_match_weighted_metric(request):
    try:
        ...
        logger.info(f"guarded | Score: {score} | GT: {ground_truth}")
